...
void startFanSilentMode(){
  if(fan_sil_mode_is_on == false){
    ...
    fan_sil_mode_is_on = true;
  } else {
    stopFanSilentMode();
    disableTimer(timer_silent_mode);
  }
}
